...
; --- ANNE-1 MONITOR LINKS (Derived from monitor.lst) ---
PUTCHR EQU   $F0E7      ; OUTCH (Line 213)
PSTRNG EQU   $F2CE      ; OUTSTR (Line 269)
PCRLF  EQU   $F290      ; OUT_CRLF (Line 261)
WARMS  EQU   $F0F6      ; RESET (Line 216) - Returns to Monitor when done
OUTDEC EQU   $F038      ; Points to KEYIN (RTS) - Dummy for unused routine

; --- MEMORY MAPPING ---
EXTREG EQU   $2000      ; Move Scratchpad to valid RAM ($0000-$3FFF)
DIRPAG EQU   $00        ; Direct Page 0
DPREG  EQU   $00

; --- TERMINATOR FIX ---
; CRITICAL: ANNE-1 Monitor expects $00 (NULL) for string termination.
; The original suite used $04 (EOT). We must redefine EOT to 0.
EOT    EQU   $00        

       ORG   $8100      ; Code Origin
...
START  LDS   #$3FFF  ; Init Stack to Top of RAM
