...
### Hardware
A TM1638 Board/Module is also needed, I used my DSKY project. I added to this repo (at the time of this writing) an untested PCB. There are also lots of TM1638 boards out there.
Just don't forget to ensure that the one you get has a 3.3V to 5V transciever (most don't) or add one. Writing to the display will work without the transciver, 
but reading keys will not. You would also need to mod the board to add additional keys.
